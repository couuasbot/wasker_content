...
services:
  - title: "Full Stack Development"
    description: "Expertise in the Vue.js and Python ecosystems. I build robust full-stack applications like the [[Wasker Series: Markdown-Driven Frontend Architecture]] (or [[Wasker 系列：极致体验的 Markdown 驱动架构]]), from intricate interactive frontends to high-performance APIs."
    link: "/contact"
  - title: "SPEC-Coding Solutions"
    description: "Implementing structured SPEC-Coding methodologies to manage complex logic. I deliver clean, maintainable, and highly scalable architectures as detailed in my [[Strategic Guidelines]] manifesto."
    link: "/contact"
  - title: "Nuclear Digital Twin"
    description: "Specializing in the Tritium Fuel Cycle. I develop high-fidelity digital twins like the [[TRICYS Ecosystem: Fusion Fuel Cycle Simulation Platform]] (or [[TRICYS 生态系统：聚变燃料循环仿真平台]]) that provide precise simulation and monitoring."
    link: "/contact"
